...
exports.extractCachedFileData = exports.shouldRecomputeWholeGraph = exports.writeCache = exports.readCache = void 0;
...
function writeCache(packageJsonDeps, nxJson, tsConfig, projectGraph) {
    ...
    fileutils_1.writeJsonFile(nxDepsPath, newValue);
...
function shouldRecomputeWholeGraph(cache, packageJsonDeps, workspaceJson, nxJson, tsConfig) {
    ...
    if (Object.keys(cache.nodes).some((p) => (cache.nodes[p].type === 'app' || cache.nodes[p].type === 'lib') &&
