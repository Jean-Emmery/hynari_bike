...
<div class="login-box">
	...
	<form action="">
      ...
      <div class="mt-3 text-white font-s1">Already have an account ? <span class="bd-b-solid bd-1 bd-white" style="font-size: 14px;"><router-link to="/register">Login now</router-link></span></div>
</div>
</template>
